...
namespace CarExpo.Infrastructure.Migrations
{
    ...
    [Migration("20250414133528_Init5")]
    partial class Init5
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarExpo.Domain.Models.Brands.Brand", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b2b0954e-c727-46fe-a6c1-e0c44c39a7a7"),
                            Title = "Saipa"
                        },
                        new
                        {
                            Id = new Guid("49041879-a332-4233-a0b9-28743647f2fe"),
                            Title = "Kia"
                        },
                        new
                        {
                            Id = new Guid("a72d863f-0909-4500-90d3-72171fe97872"),
                            Title = "Peugeot"
                        },
                        new
                        {
                            Id = new Guid("32eefa2b-f9f3-4921-a511-e2b12e814ae8"),
                            Title = "Hyundai"
                        },
                        new
                        {
                            Id = new Guid("f64efce5-8b46-4d69-9077-585ee8723a38"),
                            Title = "Chery"
                        },
                        new
                        {
                            Id = new Guid("4611a07f-2ce1-4abd-a3dd-faceb4db0f3e"),
                            Title = "Brilliance"
                        },
                        new
                        {
                            Id = new Guid("e3f9393c-8532-4406-8cec-d86545dfc1f7"),
                            Title = "Renault"
                        },
                        new
                        {
                            Id = new Guid("4076eba5-48fa-4e12-b646-f6ccb7a058f4"),
                            Title = "Lifan"
                        },
                        new
                        {
                            Id = new Guid("503546f4-7178-4173-aaa4-1994b8af9724"),
                            Title = "JAC"
                        },
                        new
                        {
                            Id = new Guid("6f57d6a7-fa47-469f-9881-2b3ec2e54abf"),
                            Title = "BahmanMotor"
                        },
                        new
                        {
                            Id = new Guid("581f92b2-e275-48ae-bf7b-c20cfa58987c"),
                            Title = "ParsKhodro"
                        },
                        new
                        {
                            Id = new Guid("a21321e2-6005-4de7-a8ed-72cc7d2c6275"),
                            Title = "ModiranKhodro"
                        },
                        new
                        {
                            Id = new Guid("e3a9138f-366a-44fa-84d7-758ea36d84d4"),
                            Title = "KermanMotor"
                        });
                });
